...
local Window = library:CreateWindow("PhonkHub", Vector2.new(492, 588), Enum.KeyCode.RightShift)
...
local ui = Window:CreateTab("Settings/UI")
local Main4 = General:CreateSector("Visual", "left")
local Main2 = General:CreateSector("Aim", "right")
ui:CreateConfigSystem("left")
...
game:GetService("UserInputService").InputBegan:Connect(function(input, gameProcessedEvent)
    ...
    game:GetService("CoreGui").PhonkHub.Enabled = not game:GetService("CoreGui").PhonkHub.Enabled
end)
